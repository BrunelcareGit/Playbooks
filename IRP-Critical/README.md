...
The Head of Digital Services and the Finance Director will
- Appoint an Incident Commander and a backup
    ...
    - Ensuring the Playbooks are followed
        ...
        - Steps are taken in the right order
            - This doesn't mean that many steps cannot be taken simultaneously
        - Chain of Custody is maintained
    - There's always someone taking notes
    - Key person to gather all information
    - Can authorise actions
        - Disconnect Internet/SDWAN
    ...
    - Can authorise spending
        ...
        - VM
            - Azure
        -  Software 
- Appoint a "minute taker" and a backup
- Create 
    - Alpha Team
    - Beta Team
    - Charlie Team
