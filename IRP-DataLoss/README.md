...
- Create email template 
    - to notify all employees of the ongoing phishing campaign against the organisation 
    - to contact hosting companies for domain take down
    - to inform 3rd party to take actions against phishing on their infrastructure (Microsoft, etc.)
- Ensure that:
    ...
    - Detection exists for office documents spawning processes
        ...
        - MSHTA
        - Etc.
- Perform Tabletop exercises to ensure all aspects of the Playbook are working
    - After publication
...
- A list of assets and owners should exist and be available for the following
    ...
    - Brunelcare Assets (Including all remote sites and business units)
        - Owners
        - Contacts
        - Administrators
...
#### Alerts
Alerts are be generated by different systems owned by the Security/Infrastructure team. The main sources for alerts are  
- Tickets
- GreyLog/SIEM
- Anti-Virus / EDR
- Reports
...
Determine the type of Data Loss we are dealing with.
- Cyber Threat
- Insider Threat
...
If the Data Loss is caused by a Ransomware, please refer to the![Ransomware Playbook](../IRP-Ransomware/)  
...
- Search Threat Intel sources
    ...
    - [Hybrid Analysis](../Tools/README.md#hybrid-analysis)
    - [Talos Intelligence](../Tools/README.md#hybrid-analysis)
- Disk forensics on the recipient's endpoint

</details>

### DA4. Malware
If **Malware** was involved in the inciden,t refer to the [Malware Playbook](../IRP-Malware/)  

### DA5. What Was Accessed
<details open>
<summary>Expand/Colapse</summary>

Did the attack touch other systems?  
Look for:  
...
If you find further traces of phishing or new IOCs, go back to [Verify Step](README.md#verify).  
...
### DA9. External Help
Does Brunelcare have all the knowledge and resources to handle the crisis alone?
...
If any customer data was accessed or leaked, we will need to send communication to all affected clients using the approved [Customer Communication Template]().  
...
### DC11. Attacker Still Has Access?
